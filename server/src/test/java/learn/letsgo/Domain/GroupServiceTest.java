...
class GroupServiceTest {
    ...
    void shouldAddContactToGroup() {
        ...
        Result<Group> actual = groupService.addContactToGroup(1,3);
    ...
    void shouldNotAddContactToGroupWhenAlreadyPresent() {
        ...
        Result<Group> actual = groupService.addContactToGroup(10,3);
        assertFalse(actual.isSuccess());
    ...
    void shouldRemoveContactFromEvent() {
        ...
        Result<Group> actual = groupService.removeContactFromGroup(10,3);
        assertTrue(actual.isSuccess());
    }
    ...
    void shouldNotRemoveContactFromEventNotInList() {
        ...
        when(groupRepository.findById(3)).thenReturn(group);
        Result<Group> actual = groupService.removeContactFromGroup(9,3);
        assertFalse(actual.isSuccess());
    }
    ...
    void shouldBatchAddContactsToGroup() {
        ...
        Result<Group> actual = groupService.batchAddContactsToGroup(contactIds, 3);
        assertTrue(actual.isSuccess());
    }
    ...
    void shouldNotBatchAddContactsToGroupWhenAContactMissing() {
        ...
        Result<Group> actual = groupService.batchAddContactsToGroup(List.of(15,17), 3);
        assertFalse(actual.isSuccess());
        assertEquals(ResultType.NOT_FOUND, actual.getStatus());
    }
    ...
    void shouldBatchUpdateContactsInGroup() {
        ...
        Result<Group> actual = groupService.batchUpdateContactsInGroup(List.of(10,14), 3);
        assertTrue(actual.isSuccess());
    }
    ...
    void shouldNotBatchUpdateContactsWhenGroupMissing() {
        ...
        Result<Group> actual = groupService.batchUpdateContactsInGroup(List.of(15,17), 3);
        assertFalse(actual.isSuccess());
        assertEquals(ResultType.NOT_FOUND, actual.getStatus());
    }
